...
#解压软件包
yum install java-1.8.0-openjdk golang -y
#tar xvzf go1.11.linux-amd64.tar.gz -C $Install_dir
#tar xvzf jdk-8u144-linux-x64.tar.gz -C $Install_dir
tar xvzf package/zookeeper-3.4.13.tar.gz -C $Install_dir
tar xvzf package/codis3.2.2-go1.8.5-linux.tar.gz -C $Install_dir
...
sed -i 's#10.144.89.189#0.0.0.0:18080#g' conf/codis.json
#启动服务
